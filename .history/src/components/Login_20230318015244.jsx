...
function Login(){
  ...
  return (
    ...
    {errors.email && <div className='loginSpan'><span className='text-red-900 text-sm bg-green-400'>*{errors.email.message}</span></div>}
    ...
    {errors.password && <div className='loginSpan'><span className='text-red-900 text-sm bg-green-400'>*{errors.password.message}</span></div>}
    </div>
