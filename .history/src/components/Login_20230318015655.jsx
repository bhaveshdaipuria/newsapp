...
function Login(){
  ...
  return (
    ...
    {errors.email && <div className='loginSpan bg-green-400 text-start mr-38'><span className='text-red-900 text-sm'>*{errors.email.message}</span></div>}
    ...
    {errors.password && <div className='loginSpan bg-green-400 text-start'><span className='text-red-900 text-sm'>*{errors.password.message}</span></div>}
    </div>
