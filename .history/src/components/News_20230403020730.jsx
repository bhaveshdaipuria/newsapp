...
function App({newsCountry, newsCategory, newsNumber, bodyColorProp, modeProp ,hColorProp ,badgeColorProp, modeSwitchProp, emailIDProp}){ 
 ...
 const capitalizeFirstLetter = (string) => {
  ...
  return(
    ...
    <div  className="navbar-nav gap-x-4">
      <NavLink to ={`/news/general/${emailIDProp}`} className="text-slate-50 no-underline font-bold">General</NavLink>
      <NavLink to ="/news/sports" className="text-slate-50 no-underline font-bold">Sports</NavLink>
      <NavLink to ="/news/science" className="text-slate-50 no-underline font-bold">Science</NavLink>
      <NavLink to ="/news/technology" className="text-slate-50 no-underline font-bold">Technology</NavLink>
      <NavLink to ="/news/health" className="text-slate-50 no-underline font-bold">Health</NavLink>
      <NavLink to ="/news/business" className="text-slate-50 no-underline font-bold">Business</NavLink>
      <NavLink to ="/news/politics" className="text-slate-50 no-underline font-bold">Politics</NavLink>
      <NavLink to ="/news/entertainment" className="text-slate-50 no-underline font-bold">Entertainment</NavLink>
    </div>
    </div> 
    {modeSwitchProp}
    </div>
