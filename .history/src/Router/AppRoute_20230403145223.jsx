...
function AppRoute() {
  ...
  return (
    ...
    <Route path='/:name' element={!signInValue === true?<Login/>:<News key='general' newsCategory='general' bodyColorProp={bodyColor} hColorProp={hColor} modeProp={mode} badgeColorProp={badgeColor} modeSwitchProp={<ModeSwitch toggleMode={toggleMode} modeTxt={modeTxt}/>}/>}/>
